        ...
        <div className="max-w-[1000px] mx-auto px-4 sm:px-8">
          ...
          <div className="mt-10 sm:mt-12 bg-white border border-[#d4c5b0] p-5 sm:p-6">
            ...
            <p className="font-serif-body text-sm sm:text-[15px] leading-relaxed text-[#5a5a5a]">
              SecondLook&rsquo;s numbers were measured on a random sample from this dataset (n=30 cases, paper-faithful Mondo grading) and compared against o1-preview and GPT-4o numbers reported in Robinson et al., 2026 (n=5,213). The Claude Opus 4.7 and OpenAI o3 numbers were generated by us on the same case sample as SecondLook, using each model in a single-shot diagnostic prompt so the comparison is head-to-head — apples-to-apples LLM evaluation throughout.
            </p>
          </div>
