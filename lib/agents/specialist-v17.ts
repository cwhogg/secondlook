...
- EXPLICIT DIFFERENTIAL: when your TOP hypothesis is phenotypically similar to other rare diseases in your candidate set (overlapping symptoms, related gene families, or same disease umbrella), your clinicalReasoning for the TOP hypothesis MUST briefly name the 2-3 closest competing diagnoses AND state ONE patient-specific feature (or one explicitly excluded feature) that distinguishes your top from each. Example structure (illustrative, not disease-specific): "Top: X. Distinguishing from Y by [patient feature]; from Z by [patient feature]; from W by [excluded feature]." If no close competitors exist, state "No close phenotypic competitors among candidates."
